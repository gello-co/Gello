...
describe('View Rendering', () => {
  ...
  describe('GET /boards/:id', () => {
    ...
    it('should render board detail page for authenticated user', async () => {
      ...
      let boardReq = request(app).post('/api/boards').set('Cookie', managerCookieHeader);
  ...
  describe('GET /leaderboard', () => {
    ...
    it('should render leaderboard for authenticated user', async () => {
      ...
      const response = await request(app).get('/leaderboard').set('Cookie', cookieHeader);
  ...
  describe('GET /profile', () => {
    ...
    it('should render profile page for authenticated user', async () => {
      ...
      const response = await request(app).get('/profile').set('Cookie', cookieHeader);
